...
import com.aziz.novi.fragment.FragmentFavorite;
import com.aziz.novi.fragment.FragmentNovel;
import com.aziz.novi.R;
import com.aziz.novi.utils.BottomBarBehavior;
...
//        });
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout, new FragmentNovel()).commit();
