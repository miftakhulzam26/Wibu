          ...
          <div class="card">
            ...
            <div class="card-body">
              <form method="POST" action="{{ isset($creator) ? route('user.update',$creator->creator_id) : route('user.store') }}">
                @csrf
                @method('PUT')
                <input type="hidden" id="creator_id" name="creator_id" value="{{ $creator->creator_id }}" class="form-control">
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      <label class="bmd-label-floating">Name</label>
                      <input type="text" id="creator_name" name="creator_name" value="{{ isset($creator) ? $creator->creator_name : '' }}" class="form-control">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label class="bmd-label-floating">Email</label>
                      <input type="email" id="creator_email" name="creator_email" value="{{ isset($creator) ? $creator->creator_email : '' }}" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="password" id="creator_password" name="creator_password" value="{{ isset($creator) ? $creator->creator_password : '' }}" class="form-control">
                        </div>
                    </div>
                </div>
                <!--<div class="col-md-4">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea id="creator_desc" name="creator_desc" class="form-control" rows="5">{{ isset($creator) ? $creator->creator_desc : '' }}</textarea>
                      </div>
                    </div>
                  </div>
                </div>
