...
<div class="container">
    ...
    <div class="section text-center">
        <div class="col-md-12">
            ...
            <button class="btn btn-primary btn-simple btn-sm">Table of Content</button>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="card-avatar">
                                <a href="#pablo">
                                    <img class="img" src="frontend/assets/img/faces/card-profile1-square.jpg">
                                </a>
                        ...
                        <div class="col-md-2">
                            <button type="button" class="btn btn-default pull-right btn-round">Visit</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="media-area">
                    ...
                    <div class="media">
                        <a class="pull-left" href="#pablo">
                            <div class="avatar">
                                <img class="media-object" src="frontend/assets/img/faces/card-profile4-square.jpg" alt="..."/>
                            </div>
                        </a>
                    ...
                    <div class="media">
                      <a class="pull-left" href="#pablo">
                          <div class="avatar">
                             <img class="media-object" alt="Tim Picture" src="frontend/assets/img/faces/card-profile1-square.jpg">
                          </div>
                      </a>
                      <div class="media-body">
                        ...
                        <div class="media-footer">
                         ...
                         <div class="media">
                              <a class="pull-left" href="#pablo">
                                    <div class="avatar">
                                        <img class="media-object" alt="64x64" src="frontend/assets/img/faces/card-profile4-square.jpg">
                                    </div>
                              </a>
                              <div class="media-body">
