package com.sulton.novi.fragment;
...
import com.sulton.novi.R;
import com.sulton.novi.activities.DetailTelevisionActivity;
import com.sulton.novi.adapter.TvAdapter;
import com.sulton.novi.adapter.TvHorizontalAdapter;
import com.sulton.novi.model.ModelTV;
import com.sulton.novi.networking.ApiEndpoint;
...
//                + ApiEndpoint.APIKEY + ApiEndpoint.LANGUAGE + ApiEndpoint.QUERY + query
    ...
    private void getTvHorizontal() {
        progressDialog.show();
        AndroidNetworking.get(ApiEndpoint.BASEURL
//                + ApiEndpoint.TV_PLAYNOW + ApiEndpoint.APIKEY + ApiEndpoint.LANGUAGE
                )
                .setPriority(Priority.HIGH)
                .build()
                .getAsJSONObject(new JSONObjectRequestListener() {
    ...
    private void getFilmTV() {
        progressDialog.show();
        AndroidNetworking.get(ApiEndpoint.BASEURL
//                + ApiEndpoint.TV_POPULAR + ApiEndpoint.APIKEY + ApiEndpoint.LANGUAGE
                )
                .setPriority(Priority.HIGH)
                .build()
                .getAsJSONObject(new JSONObjectRequestListener() {
