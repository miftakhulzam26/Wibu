package com.sulton.novi.networking;
...
//    public static String BASEURL = "http://api.themoviedb.org/3/";
    public static String BASEURL = "https://wsjti.id/novi/public/api/title/";
...
//    public static String SEARCH_MOVIE = "search/movie?";
    public static String SEARCH = "https://wsjti.id/novi/public/api/title/";
...
//    public static String TV_POPULAR = "discover/tv?";
    public static String URLIMAGE = "https://wsjti.id/novi/public/images/";
