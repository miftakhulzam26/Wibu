...
public class com_sulton_novi_model_ModelTVRealmProxy extends com.sulton.novi.model.ModelTV
    implements RealmObjectProxy, com_sulton_novi_model_ModelTVRealmProxyInterface {
    ...
    private ProxyState<com.sulton.novi.model.ModelTV> proxyState;

    com_sulton_novi_model_ModelTVRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.sulton.novi.model.ModelTV>(this);
    ...
    @SuppressWarnings("cast")
    public static com.sulton.novi.model.ModelTV createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.sulton.novi.model.ModelTV obj = realm.createObjectInternal(com.sulton.novi.model.ModelTV.class, true, excludeFields);

        final com_sulton_novi_model_ModelTVRealmProxyInterface objProxy = (com_sulton_novi_model_ModelTVRealmProxyInterface) obj;
        if (json.has("Id")) {
            if (json.isNull("Id")) {
    ...
    public static com.sulton.novi.model.ModelTV createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.sulton.novi.model.ModelTV obj = new com.sulton.novi.model.ModelTV();
        final com_sulton_novi_model_ModelTVRealmProxyInterface objProxy = (com_sulton_novi_model_ModelTVRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.sulton.novi.model.ModelTV copyOrUpdate(Realm realm, com.sulton.novi.model.ModelTV object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.sulton.novi.model.ModelTV) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.sulton.novi.model.ModelTV copy(Realm realm, com.sulton.novi.model.ModelTV newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.sulton.novi.model.ModelTV realmObject = realm.createObjectInternal(com.sulton.novi.model.ModelTV.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_sulton_novi_model_ModelTVRealmProxyInterface realmObjectSource = (com_sulton_novi_model_ModelTVRealmProxyInterface) newObject;
        com_sulton_novi_model_ModelTVRealmProxyInterface realmObjectCopy = (com_sulton_novi_model_ModelTVRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.sulton.novi.model.ModelTV object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.sulton.novi.model.ModelTV.class);
        long tableNativePtr = table.getNativePtr();
        ModelTVColumnInfo columnInfo = (ModelTVColumnInfo) realm.getSchema().getColumnInfo(com.sulton.novi.model.ModelTV.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.IdIndex, rowIndex, ((com_sulton_novi_model_ModelTVRealmProxyInterface) object).realmGet$Id(), false);
        String realmGet$Name = ((com_sulton_novi_model_ModelTVRealmProxyInterface) object).realmGet$Name();
        if (realmGet$Name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.NameIndex, rowIndex, realmGet$Name, false);
        }
        Table.nativeSetDouble(tableNativePtr, columnInfo.VoteAverageIndex, rowIndex, ((com_sulton_novi_model_ModelTVRealmProxyInterface) object).realmGet$VoteAverage(), false);
        String realmGet$Overview = ((com_sulton_novi_model_ModelTVRealmProxyInterface) object).realmGet$Overview();
        if (realmGet$Overview != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.OverviewIndex, rowIndex, realmGet$Overview, false);
        }
        String realmGet$ReleaseDate = ((com_sulton_novi_model_ModelTVRealmProxyInterface) object).realmGet$ReleaseDate();
        ...
        String realmGet$PosterPath = ((com_sulton_novi_model_ModelTVRealmProxyInterface) object).realmGet$PosterPath();
        ...
        String realmGet$BackdropPath = ((com_sulton_novi_model_ModelTVRealmProxyInterface) object).realmGet$BackdropPath();
        ...
        String realmGet$Popularity = ((com_sulton_novi_model_ModelTVRealmProxyInterface) object).realmGet$Popularity();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ModelTVColumnInfo columnInfo = (ModelTVColumnInfo) realm.getSchema().getColumnInfo(com.sulton.novi.model.ModelTV.class);
        com.sulton.novi.model.ModelTV object = null;
        while (objects.hasNext()) {
            object = (com.sulton.novi.model.ModelTV) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.sulton.novi.model.ModelTV object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.sulton.novi.model.ModelTV.class);
    ...
    public static com.sulton.novi.model.ModelTV createDetachedCopy(com.sulton.novi.model.ModelTV realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.sulton.novi.model.ModelTV unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.sulton.novi.model.ModelTV();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.sulton.novi.model.ModelTV) cachedObject.object;
            }
            unmanagedObject = (com.sulton.novi.model.ModelTV) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_sulton_novi_model_ModelTVRealmProxyInterface unmanagedCopy = (com_sulton_novi_model_ModelTVRealmProxyInterface) unmanagedObject;
        com_sulton_novi_model_ModelTVRealmProxyInterface realmSource = (com_sulton_novi_model_ModelTVRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_sulton_novi_model_ModelTVRealmProxy aModelTV = (com_sulton_novi_model_ModelTVRealmProxy)o;
