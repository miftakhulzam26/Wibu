...
public class com_sulton_novi_model_ModelMovieRealmProxy extends com.sulton.novi.model.ModelMovie
    implements RealmObjectProxy, com_sulton_novi_model_ModelMovieRealmProxyInterface {
    ...
    private ProxyState<com.sulton.novi.model.ModelMovie> proxyState;

    com_sulton_novi_model_ModelMovieRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.sulton.novi.model.ModelMovie>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("ModelMovie", 7, 0);
    ...
    @SuppressWarnings("cast")
    public static com.sulton.novi.model.ModelMovie createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.sulton.novi.model.ModelMovie obj = realm.createObjectInternal(com.sulton.novi.model.ModelMovie.class, true, excludeFields);

        final com_sulton_novi_model_ModelMovieRealmProxyInterface objProxy = (com_sulton_novi_model_ModelMovieRealmProxyInterface) obj;
        if (json.has("Id")) {
            if (json.isNull("Id")) {
    ...
    public static com.sulton.novi.model.ModelMovie createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.sulton.novi.model.ModelMovie obj = new com.sulton.novi.model.ModelMovie();
        final com_sulton_novi_model_ModelMovieRealmProxyInterface objProxy = (com_sulton_novi_model_ModelMovieRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.sulton.novi.model.ModelMovie copyOrUpdate(Realm realm, com.sulton.novi.model.ModelMovie object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.sulton.novi.model.ModelMovie) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.sulton.novi.model.ModelMovie copy(Realm realm, com.sulton.novi.model.ModelMovie newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.sulton.novi.model.ModelMovie realmObject = realm.createObjectInternal(com.sulton.novi.model.ModelMovie.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_sulton_novi_model_ModelMovieRealmProxyInterface realmObjectSource = (com_sulton_novi_model_ModelMovieRealmProxyInterface) newObject;
        com_sulton_novi_model_ModelMovieRealmProxyInterface realmObjectCopy = (com_sulton_novi_model_ModelMovieRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.sulton.novi.model.ModelMovie object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.sulton.novi.model.ModelMovie.class);
        long tableNativePtr = table.getNativePtr();
        ModelMovieColumnInfo columnInfo = (ModelMovieColumnInfo) realm.getSchema().getColumnInfo(com.sulton.novi.model.ModelMovie.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.IdIndex, rowIndex, ((com_sulton_novi_model_ModelMovieRealmProxyInterface) object).realmGet$Id(), false);
        String realmGet$Title = ((com_sulton_novi_model_ModelMovieRealmProxyInterface) object).realmGet$Title();
        if (realmGet$Title != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.TitleIndex, rowIndex, realmGet$Title, false);
        }
        Table.nativeSetDouble(tableNativePtr, columnInfo.VoteAverageIndex, rowIndex, ((com_sulton_novi_model_ModelMovieRealmProxyInterface) object).realmGet$VoteAverage(), false);
        String realmGet$Overview = ((com_sulton_novi_model_ModelMovieRealmProxyInterface) object).realmGet$Overview();
        if (realmGet$Overview != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.OverviewIndex, rowIndex, realmGet$Overview, false);
        }
        String realmGet$ReleaseDate = ((com_sulton_novi_model_ModelMovieRealmProxyInterface) object).realmGet$ReleaseDate();
        ...
        String realmGet$PosterPath = ((com_sulton_novi_model_ModelMovieRealmProxyInterface) object).realmGet$PosterPath();
        ...
        String realmGet$BackdropPath = ((com_sulton_novi_model_ModelMovieRealmProxyInterface) object).realmGet$BackdropPath();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ModelMovieColumnInfo columnInfo = (ModelMovieColumnInfo) realm.getSchema().getColumnInfo(com.sulton.novi.model.ModelMovie.class);
        com.sulton.novi.model.ModelMovie object = null;
        while (objects.hasNext()) {
            object = (com.sulton.novi.model.ModelMovie) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.sulton.novi.model.ModelMovie object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.sulton.novi.model.ModelMovie.class);
    ...
    public static com.sulton.novi.model.ModelMovie createDetachedCopy(com.sulton.novi.model.ModelMovie realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.sulton.novi.model.ModelMovie unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.sulton.novi.model.ModelMovie();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.sulton.novi.model.ModelMovie) cachedObject.object;
            }
            unmanagedObject = (com.sulton.novi.model.ModelMovie) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_sulton_novi_model_ModelMovieRealmProxyInterface unmanagedCopy = (com_sulton_novi_model_ModelMovieRealmProxyInterface) unmanagedObject;
        com_sulton_novi_model_ModelMovieRealmProxyInterface realmSource = (com_sulton_novi_model_ModelMovieRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_sulton_novi_model_ModelMovieRealmProxy aModelMovie = (com_sulton_novi_model_ModelMovieRealmProxy)o;
